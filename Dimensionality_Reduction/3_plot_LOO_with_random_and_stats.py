...
"""
Plot leave-one-out reconstruction performance against shuffled-space controls.

This script loads leave-one-out reconstruction results for the sporadic
...
Performance is shown separately for held-out data and training data using:
    - RMSE
...
Wilcoxon signed-rank tests. The t-test p-value is used for plot annotation.

Outputs
-------
figures/
    RMSE_LOO_violin_with_random_and_shuffled.svg
    RMSE_LOO_violin_with_random_and_shuffled.png
    Corr_LOO_violin_with_random_and_shuffled.svg
    Corr_LOO_violin_with_random_and_shuffled.png
    RMSE_LOO_violin_with_random_and_shuffled_train.svg
    RMSE_LOO_violin_with_random_and_shuffled_train.png
    Corr_LOO_violin_with_random_and_shuffled_train.svg
    Corr_LOO_violin_with_random_and_shuffled_train.png
"""
...
# ---------------------------------------------------------------------
# Load leave-one-out performance results
# ---------------------------------------------------------------------
...
with open(input_file, "rb") as file:
    data_LOO = pd.read_pickle(file)

df_rmse_TT = data_LOO["df_performance_RMSE"]
df_corr_TT = data_LOO["df_performance_corr"]
total_dims_array_TT = data_LOO["total_dims"]


# ---------------------------------------------------------------------
# Prepare held-out data performance
# ---------------------------------------------------------------------
...
plot_combined_violin(
    ...
    "RMSE",
    "RMSE",
    "RMSE_LOO_violin_with_random_and_shuffled",
    palette,
    "Held out data",
    pairs_to_compare,
)
...
plot_combined_violin(
    ...
    "Correlation",
    "Correlation",
    "Corr_LOO_violin_with_random_and_shuffled",
    palette,
    "Held out data",
    pairs_to_compare,
)
...
plot_combined_violin(
    ...
    "RMSE",
    "RMSE",
    "RMSE_LOO_violin_with_random_and_shuffled_train",
    palette,
    "Train",
    pairs_to_compare,
)
...
plot_combined_violin(
    ...
    "Correlation",
    "Correlation",
    "Corr_LOO_violin_with_random_and_shuffled_train",
    palette,
    "Train",
    pairs_to_compare,
)
