...
"""
Plot train-test reconstruction performance against shuffled-space controls.

This script loads repeated train-test reconstruction results for the sporadic
baseline cohort and compares reconstruction performance between:

    1. The true baseline low-dimensional space
    2. A shuffled eigenvector-space control

Performance is shown separately for test data and training data using:
    - RMSE
...
-------
figures/
    RMSE_test_train_violin_with_random_and_shuffled.svg
    RMSE_test_train_violin_with_random_and_shuffled.png
    Corr_test_train_violin_with_random_and_shuffled.svg
    Corr_test_train_violin_with_random_and_shuffled.png
    RMSE_test_train_violin_with_random_and_shuffled_train.svg
    RMSE_test_train_violin_with_random_and_shuffled_train.png
    Corr__test_train_violin_with_random_and_shuffled_train.svg
    Corr__test_train_violin_with_random_and_shuffled_train.png
"""
...
def plot_combined_violin(
    ...
    plt.xlabel("")
    plt.xticks(fontsize=fig_properties["fontsize"], rotation=0)
...
# ---------------------------------------------------------------------
# Load train-test performance results
# ---------------------------------------------------------------------
...
input_file = os.path.join(
    saved_data_dir,
    f"Data_test_train_{class_name}_BL_5fold_50runs.pkl",
)

with open(input_file, "rb") as file:
    data_test_train = pd.read_pickle(file)

df_rmse_TT = data_test_train["df_performance_RMSE"]
df_corr_TT = data_test_train["df_performance_corr"]


# ---------------------------------------------------------------------
# Prepare test-data performance
# ---------------------------------------------------------------------

rmse_sources = [
    (df_rmse_TT["RMSE:test SE"].values, "BL space"),
    (df_rmse_TT["shuffled RMSE:test SE"].values, "Shuffled Space"),
]

corr_sources = [
    (df_corr_TT["Corr:test SE"].values, "BL space"),
    (df_corr_TT["shuffled Corr:test SE"].values, "Shuffled Space"),
]
...
plot_combined_violin(
    ...
    "RMSE",
    "RMSE",
    "RMSE_test_train_violin_with_random_and_shuffled",
    palette,
    "Test",
    pairs_to_compare,
)
...
plot_combined_violin(
    ...
    "Correlation",
    "Correlation",
    "Corr_test_train_violin_with_random_and_shuffled",
    palette,
    "Test",
    pairs_to_compare,
)
...
rmse_sources = [
    (df_rmse_TT["RMSE:train SE"].values, "BL space"),
    (df_rmse_TT["shuffled RMSE:train SE"].values, "Shuffled Space"),
]

corr_sources = [
    (df_corr_TT["Corr:train SE"].values, "BL space"),
    (df_corr_TT["shuffled Corr:train SE"].values, "Shuffled Space"),
]
...
plot_combined_violin(
    ...
    "RMSE",
    "RMSE",
    "RMSE_test_train_violin_with_random_and_shuffled_train",
    palette,
    "Train",
    pairs_to_compare,
)
...
plot_combined_violin(
    ...
    "Correlation",
    "Correlation",
    "Corr__test_train_violin_with_random_and_shuffled_train",
    palette,
    "Train",
    pairs_to_compare,
)
